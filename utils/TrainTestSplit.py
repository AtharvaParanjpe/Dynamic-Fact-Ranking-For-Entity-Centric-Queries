...
## filename: File to be split into Train-Test
## train: location to store the train split
## test: location to store the test split

## HAS BEEN CALLED RECURSIVELY FOR 5-FOLD Cross valication


filename = '../data/Complete_Data_With_Targets.csv'
train = open("../data/CompleteData/Utility/TrainingData4.txt", "w")

test = open("../data/CompleteData/Utility/TestingData4.txt", "w")
